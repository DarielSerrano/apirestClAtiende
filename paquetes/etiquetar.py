...
keywords = {
    ...
    "Pareja y Familia": ["matrimonio","familia","acuerdo de union civil","divorcio","subsidio familiar","pareja"],
    ...
    "Vivienda": ["vivienda","subsidio a la vivienda","subsidio al arriendo","subsidio al mejoramiento","arriendo","arrendataria","arrendatario","hogares","rsh"],
