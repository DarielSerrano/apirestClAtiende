...
keywords = {
    ...
    "Extranjeros en Chile": ["extranjeros en chile","permisos","prolongaciones","residencia definitiva","nacionalizacion","extranjero","visado de trabajo" ,"inmigracion ilegal" ,"refugio en Chile" ,"ley de extranjeria"],
