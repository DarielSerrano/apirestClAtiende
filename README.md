...
#   librerías de python necesarias para el DESARROLLO nlp
...
#   crear y dar permisos a apache para las carpetas archivos, cache, librerías y cache para su administración
...
# ( para que Apache, como servidor web, pueda acceder a las librerías en la integración y ejecución, debe instalar los paquetes de pip con: sudo -u www-data pip y dirigirlos a una carpeta específica  )
